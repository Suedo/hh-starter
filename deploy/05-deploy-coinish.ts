...
module.exports = async (hre: HardhatRuntimeEnvironment) => {
  ...
  const deployTx = Basic.getDeployTransaction();
  ...
  console.log("Contract Basic deployed to address: ", address);
  ...
  console.log("Basic's owner: ", await basic.owner());
  console.log("Basic's owner balance: ", (await basic.getBalanceOf(wallet.address)).toString());
};
